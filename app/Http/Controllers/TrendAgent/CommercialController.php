...
{
    /**
     * Получение списка коммерческой недвижимости с фильтрами
     * 
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            Log::error('Ошибка получения списка коммерческой недвижимости', [
    ...
    public function show(Request $request, string $id)
    {
        ...
        try {
            ...
            Log::error('Ошибка получения детальной информации о коммерческой недвижимости', [
                'id' => $id,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
