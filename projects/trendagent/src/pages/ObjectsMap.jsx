    ...
    blocksWithCoords.forEach((block) => {
      ...
      const marker = new window.ymaps.Placemark(
        ...
        },
        {
          ...
          iconImageSize: [90, 36],
          // iconImageOffset: смещение точки привязки от ЦЕНТРА иконки (по документации Яндекс.Карт)
          // Маркер: 90px ширина, 36px высота
          // Центр иконки: [0, 0] (по умолчанию)
          // Точка привязки должна быть внизу по центру (где стрелка указывает на координаты)
          // От центра [0, 0] до точки привязки внизу: смещение [0, 18] (вниз на половину высоты)
