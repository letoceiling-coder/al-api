    ...
    blocksWithCoords.forEach((block) => {
      ...
      const marker = new window.ymaps.Placemark(
        ...
        },
        {
          ...
          // Для маркера высотой 36px точка привязки должна быть внизу (где стрелка)
          // Центр иконки: [45, 18], точка привязки внизу: [45, 36]
          // Смещение от центра: [0, 18] (вниз на половину высоты)
