...
const HousesCheckerboard = () => {
  ...
  const loadBuildings = async () => {
    ...
    try {
      const params = {
        phone,
        password,
        room: [30, 40], // Для домов: коттеджи и таунхаусы
      }

      const response = await trendAgentAPI.getCheckerboardBuildings(id, params)
  ...
  const loadApartments = async () => {
    ...
    try {
      ...
      const response = await trendAgentAPI.getCheckerboardApartments(id, params)
...
export default HousesCheckerboard
